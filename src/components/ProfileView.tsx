        ...
        <div className="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm shadow-slate-100/40 space-y-4">
          <div className={`flex items-start gap-4 ${isAr ? "flex-row-reverse text-right" : "flex-row text-left"}`}>
            ...
            <div className="space-y-1 flex-1">
              ...
              <p className="text-xs text-slate-500 leading-normal">
                {isAr 
                  ? "قم بتسجيل الدخول باستخدام Google لمزامنة وحفظ نقاط الخبرة (XP) ومساهماتك بشكل آمن عبر جميع أجهزتك على الفور." 
                  : "Sign in with Google to securely sync and save your XP points and travel contributions across all devices instantly."}
              </p>
            </div>
          </div>
          ...
          <div className="space-y-3 pt-2">
            ...
            <p className="text-[10px] text-slate-400 text-center">
              {isAr 
                ? "سيفتح هذا اختيار حساب Google الخاص بك على جهازك تلقائياً." 
                : "This will open the official Google account chooser on your device."}
            </p>
          </div>
        </div>
      )}
